...
const ObsComportamental = () => {
  ...
  return (
    <>
      ...
      <E.ContentImg2 src={HeaderGreenTeste} />
      <E.ContentListMarginObs>
        <E.ContentImg4 src={ChekedImg} />
        Aplicação de Teste
      </E.ContentListMarginObs>
      <E.ContentImg3 style={{ marginTop: '-51px' }} src={HeaderObs} />
      <E.ContentListMargin2Obs>Observação Comportamental</E.ContentListMargin2Obs>
      <E.ContentStyleObs>
        ...
        <E.ButtonSalvarList onClick={() => Navigate('/AvaliaçaoSucess')} style={{ marginTop: '40px' }}>
          <img src={Disket} />
          Salvar
        </E.ButtonSalvarList>
      </E.ContentStyleObs>
