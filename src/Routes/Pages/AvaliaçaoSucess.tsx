...
const AvaliaçaoSucess = () => {
  ...
  return (
    <>
      ...
      <E.ContentImg3 src={HeaderGreenTeste} style={{ marginTop: '-49px' }} />
      <E.ContentListSucessObs>
        <E.ContentImg4 src={ChekedImg} />
      ...
      <T.AvaliaçaoSucessContent>
        ...
        <T.ContentSubTitleSucesso>
          Você irá visualizar está avaliação no prontuário do paciente!
        </T.ContentSubTitleSucesso>
