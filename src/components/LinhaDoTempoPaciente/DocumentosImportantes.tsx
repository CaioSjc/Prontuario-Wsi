...
function DocumentosImportantesCard () {
    ...
    return (
        <>
            ...
            <C.StyleContentAnexo>
                <C.StyleIconAnexo><img src={documentosImportantesCard} /></C.StyleIconAnexo>
                ...
                <ContentCardFato><Truncate>Anexo hoje alguns documentos importantes sobre as consultas recentes da paciente Ana Ester Resende. Documentos para serem consultados posteriormente, caso necessário.</Truncate></ContentCardFato>
