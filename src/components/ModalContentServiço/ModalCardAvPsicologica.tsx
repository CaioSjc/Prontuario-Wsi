    ...
    <>
      {isOpen && (
        <ModalWindow>
          ...
          <ModalContentAv>
            <ModalAvPsicologica>Nova Avaliação Psicológica</ModalAvPsicologica>
            <CloseButtonAnexo onClick={onClose}>
            ...
            <CancelaCriaAvPsicologica>
              <StyleCampoObrigatório>*Campos Obrigatórios</StyleCampoObrigatório>
              <ButtonCancelaAv onClick={onClose}>Cancelar</ButtonCancelaAv>
              <ProsseguirAvPsicologica type={'submit'} onClick={() => Navigate('/Entrevista')}>
                Prosseguir
              </ProsseguirAvPsicologica>
            </CancelaCriaAvPsicologica>
          </ModalContentAv>
        </ModalWindow>
      )}
