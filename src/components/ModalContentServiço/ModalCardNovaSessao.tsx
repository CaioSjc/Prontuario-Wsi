    ...
    <>
      {isOpen && (
        <ModalWindow>
          ...
          <ModalContent>
            <ModalNovaSessao>Nova Sessão</ModalNovaSessao>
            ...
            <Scroll>
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <StyleContentDados>Dados Gerais</StyleContentDados>
                <StyleForm>
                ...
                <StyleContentDados>Sessão</StyleContentDados>
                <StyleForm2>
                ...
                <StyleFormTextArea>
                  ...
                  <C.SpanMessageObrigatorio style={{ width: '148px' }}>
                    {errors.resumoSessao?.message}
                  </C.SpanMessageObrigatorio>
                </StyleFormTextArea>
                <StyleHr2 />
                <StyleContentText>
                  <ContentText>3</ContentText>
                </StyleContentText>
                <StyleContentDados>Pagamento</StyleContentDados>
                <StyleForm>
                ...
                <StyleContentIconDica src={Dica} />
                <StyleContentDica>
                  Dica: Registrar os pagamentos das sessões irá te auxiliar na sua organização financeira.
                </StyleContentDica>
            ...
            <StyleCancelaCria>
              ...
              <StyleButtonCancela onClick={onClose}>Cancelar</StyleButtonCancela>
            </StyleCancelaCria>
          </ModalContent>
        </ModalWindow>
      )}
