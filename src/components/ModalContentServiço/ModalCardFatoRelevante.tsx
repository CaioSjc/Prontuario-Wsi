import { ModalContentFato, CloseButtonFatoRelevante, CloseIconModal,  ModalBackground,   ModalFatoRelevante,  ModalWindow, StyleForm,  LabelDataFatoRelevante, InputDataFatoRelevante, StyleFormFatoRelevante,  StyleCampoObrigatório, ButtonCancela } from "../../Styles/StyleModal"
import { ContentCancelaCriaFato, ContentCriaFato, InputDescriçaoFatoRelevante, InputTituloFatoRelevante, LabelDescriçaoFatoRelevante, LabelTituloFatoRelevante } from "../../Styles/StyleCardFatoRelevante"
    ...
    {isOpen && (
      <ModalWindow>
        ...
        <ModalContentFato>
          ...
          <CloseButtonFatoRelevante onClick={onClose}><CloseIconModal src={Close} /></CloseButtonFatoRelevante>
          ...
          <ContentCancelaCriaFato><StyleCampoObrigatório>*Campos Obrigatórios</StyleCampoObrigatório><ButtonCancela onClick={onClose} >Cancelar</ButtonCancela><ContentCriaFato type={"submit"} >Criar</ContentCriaFato></ContentCancelaCriaFato>
          </form>        
        </ModalContentFato>
      </ModalWindow>    
    )}
