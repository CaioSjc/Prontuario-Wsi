  ...
  const ModalAppTeste = ({ isOpen, onClose }: ModalProps) => {
    ...
    return (
        <>
          {isOpen && (                     
            <T.ModalAppTeste>
              <T.SubTitleCardContent><T.CardAtençao>Atenção Concentrada/Seletiva</T.CardAtençao><s.StyleDeleteAppTeste onClick={onClose} ><img src={Delete}/></s.StyleDeleteAppTeste></T.SubTitleCardContent>
