...
type ModalProps = {
  ...
  const ModalAppInteligencia = ({ isOpen, onClose }: ModalProps) => {
    

    return (
        <>
          {isOpen && (          
            <T.ModalAppInteligencia>
            <T.SubTitleCardContent><T.CardAtençao>Inteligência</T.CardAtençao><s.StyleDeleteAppTeste onClick={onClose} ><img src={Delete}/></s.StyleDeleteAppTeste></T.SubTitleCardContent>
...
export default ModalAppInteligencia