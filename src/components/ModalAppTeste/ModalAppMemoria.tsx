  ...
  const ModalAppMemoria = ({ isOpen, onClose }: ModalProps) => {
    ...
    return (
        <>
          {isOpen && (          
            <T.ModalAppMemoria>
            <T.SubTitleCardContent><T.CardAtençao>Memória</T.CardAtençao><s.StyleDeleteAppTeste onClick={onClose} ><img src={Delete}/></s.StyleDeleteAppTeste></T.SubTitleCardContent>
