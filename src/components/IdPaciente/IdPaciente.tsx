  ...
  return (
    <>
      <S.Content>
        ...
        <S.Icon src={Person} />
        <Label label="Paciente" value="Ana Ester Resende" />
        <S.Icon src={Calendar} />
        <Label label="Nascimento" value="10/09/2000" />
        <S.Icon src={Teacher} />
        <Label label="Profissão" value="Designer" />
        <S.Icon src={Schooling} />
        <Label label="Escolaridade" value="Superior" />
      </S.Content>
    </>
  )
}
